...
import { p as parseURL, e as encodePath, i as decodePath, k as hasProtocol, l as isScriptProtocol, m as joinURL, w as withQuery, s as sanitizeStatusCode, n as getContext, $ as $fetch, o as defu$1, q as createHooks, c as createError$1, r as executeAsync } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "cart",
    path: "/cart",
    component: () => import('./cart-BUVut8D-.mjs')
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    name: "user-login",
    path: "/user/login",
    component: () => import('./login-DLrI0Jex.mjs')
  },
  {
    name: "lodging-list",
    path: "/lodging/list",
  ...
  },
  {
    name: "user-profile",
    path: "/user/profile",
    component: () => import('./profile-DVO_qORe.mjs')
  },
  {
    name: "clothing-list",
    path: "/clothing/list",
...
const auth_45global = /* @__PURE__ */ defineNuxtRouteMiddleware(() => {
});
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-vJNLnoNN.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-ymd4k6WU.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Degb0C9m.mjs'));
