...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "community-feed-page" }, _attrs))} data-v-ee0e9504><div class="container page-inner" data-v-ee0e9504><div class="page-header" data-v-ee0e9504><h1 data-v-ee0e9504>\u6E38\u8BB0\u793E\u533A</h1><p class="page-desc" data-v-ee0e9504>\u5206\u4EAB\u4F60\u7684\u4E4C\u4E1C\u4E4B\u65C5</p>`);
      ...
      _push(`</div><div class="miao-divider" data-v-ee0e9504></div><div class="feed-tabs" data-v-ee0e9504><button class="${ssrRenderClass(["feed-tab", { active: activeTab.value === "recommend" }])}" data-v-ee0e9504>\u63A8\u8350</button><button class="${ssrRenderClass(["feed-tab", { active: activeTab.value === "latest" }])}" data-v-ee0e9504>\u6700\u65B0</button><button class="${ssrRenderClass(["feed-tab", { active: activeTab.value === "hot" }])}" data-v-ee0e9504>\u6700\u70ED</button></div><div class="masonry-grid" data-v-ee0e9504><!--[-->`);
      ssrRenderList(articles.value, (art, idx) => {
        _push(`<div class="masonry-item" data-v-ee0e9504>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", art.cover)}${ssrRenderAttr("alt", art.title)} class="masonry-img" data-v-ee0e9504${_scopeId}><div class="masonry-body" data-v-ee0e9504${_scopeId}><h3 class="masonry-title" data-v-ee0e9504${_scopeId}>${ssrInterpolate(art.title)}</h3><div class="masonry-footer" data-v-ee0e9504${_scopeId}><img${ssrRenderAttr("src", art.authorAvatar)} alt="" class="author-avatar" data-v-ee0e9504${_scopeId}><span class="author-name" data-v-ee0e9504${_scopeId}>${ssrInterpolate(art.author)}</span><span class="masonry-stats" data-v-ee0e9504${_scopeId}>\u2764 ${ssrInterpolate(art.likes)} \xB7 \u{1F4AC} ${ssrInterpolate(art.comments)}</span></div></div>`);
            } else {
              return [
                createVNode("img", {
                  src: art.cover,
...
const feed = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ee0e9504"]]);

export { feed as default };
//# sourceMappingURL=feed-vGSAB9A5.mjs.map
