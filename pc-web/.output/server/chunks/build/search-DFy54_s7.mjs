...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "search-page" }, _attrs))} data-v-f360b83d><div class="container page-inner" data-v-f360b83d><section class="search-hero" data-v-f360b83d><div data-v-f360b83d><span class="search-kicker" data-v-f360b83d>\u7EFC\u5408\u68C0\u7D22</span><h1 data-v-f360b83d>\u641C\u7D22\u201C${ssrInterpolate(unref(keyword) || "\u4E4C\u4E1C\u6587\u65C5")}\u201D</h1><p data-v-f360b83d>\u4ECE\u975E\u9057\u5546\u54C1\u3001\u7F8E\u98DF\u9910\u5385\u3001\u7279\u8272\u6C11\u5BBF\u3001\u65C5\u6E38\u7EBF\u8DEF\u548C\u793E\u533A\u6E38\u8BB0\u4E2D\u67E5\u627E\u76F8\u5173\u5185\u5BB9\u3002</p></div><div class="search-card" data-v-f360b83d><input${ssrRenderAttr("value", unref(searchText))} type="text" placeholder="\u641C\u7D22\u5546\u54C1/\u9910\u5385/\u6C11\u5BBF/\u7EBF\u8DEF" data-v-f360b83d><button type="button" data-v-f360b83d>\u641C\u7D22</button></div></section><div class="miao-divider" data-v-f360b83d></div><div class="search-summary" data-v-f360b83d><span data-v-f360b83d>\u5171\u627E\u5230 ${ssrInterpolate(unref(filteredResults).length)} \u6761\u76F8\u5173\u7ED3\u679C</span><div class="search-tabs" data-v-f360b83d><!--[-->`);
      ssrRenderList(tabs, (tab) => {
        _push(`<button class="${ssrRenderClass(["search-tab", { active: unref(activeType) === tab.value }])}" type="button" data-v-f360b83d>${ssrInterpolate(tab.label)}</button>`);
      });
      _push(`<!--]--></div></div>`);
      if (unref(visibleResults).length) {
        _push(`<div class="result-grid" data-v-f360b83d><!--[-->`);
        ssrRenderList(unref(visibleResults), (item) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<img${ssrRenderAttr("src", item.image)}${ssrRenderAttr("alt", item.title)} class="result-cover" data-v-f360b83d${_scopeId}><div class="result-body" data-v-f360b83d${_scopeId}><span class="result-type" data-v-f360b83d${_scopeId}>${ssrInterpolate(item.typeLabel)}</span><h2 data-v-f360b83d${_scopeId}>${ssrInterpolate(item.title)}</h2><p data-v-f360b83d${_scopeId}>${ssrInterpolate(item.description)}</p><div class="result-meta" data-v-f360b83d${_scopeId}><span data-v-f360b83d${_scopeId}>${ssrInterpolate(item.meta)}</span>`);
                if (item.price) {
                  _push2(`<strong data-v-f360b83d${_scopeId}>\xA5${ssrInterpolate(item.price)}</strong>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></div>`);
        ...
        _push(`<div class="empty-state" data-v-f360b83d><h2 data-v-f360b83d>\u6682\u672A\u627E\u5230\u76F8\u5173\u5185\u5BB9</h2><p data-v-f360b83d>\u6362\u4E00\u4E2A\u5173\u952E\u8BCD\u8BD5\u8BD5\uFF0C\u6BD4\u5982\u201C\u94F6\u9970\u201D\u201C\u957F\u684C\u5BB4\u201D\u201C\u6C11\u5BBF\u201D\u3002</p></div>`);
      }
      _push(`</div></div>`);
    };
  }
...
const search = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f360b83d"]]);

export { search as default };
//# sourceMappingURL=search-DFy54_s7.mjs.map
