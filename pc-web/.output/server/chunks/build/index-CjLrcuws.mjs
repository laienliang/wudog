...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "travel-page" }, _attrs))} data-v-8c811ca8><div class="container page-inner" data-v-8c811ca8><div class="page-header" data-v-8c811ca8><h1 data-v-8c811ca8>\u666F\u533A\u7EBF\u8DEF</h1><p class="page-desc" data-v-8c811ca8>\u666F\u533A\u95E8\u7968\u3001\u65C5\u6E38\u8DEF\u7EBF\u5957\u9910\u3001\u4EA4\u901A\u653B\u7565</p></div><div class="miao-divider" data-v-8c811ca8></div><div class="travel-tabs" data-v-8c811ca8><button class="${ssrRenderClass(["travel-tab", { active: activeTab.value === "scenic" }])}" data-v-8c811ca8>\u666F\u533A</button><button class="${ssrRenderClass(["travel-tab", { active: activeTab.value === "route" }])}" data-v-8c811ca8>\u8DEF\u7EBF\u5957\u9910</button><button class="${ssrRenderClass(["travel-tab", { active: activeTab.value === "guide" }])}" data-v-8c811ca8>\u4EA4\u901A\u653B\u7565</button></div>`);
      if (activeTab.value === "scenic") {
        _push(`<div class="scenic-grid" data-v-8c811ca8><!--[-->`);
        ssrRenderList(scenicList.value, (item, idx) => {
          _push(`<div class="scenic-card" data-v-8c811ca8>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<img${ssrRenderAttr("src", item.mainImage)}${ssrRenderAttr("alt", item.name)} class="scenic-img" data-v-8c811ca8${_scopeId}><div class="scenic-body" data-v-8c811ca8${_scopeId}><h3 class="scenic-name" data-v-8c811ca8${_scopeId}>${ssrInterpolate(item.name)}</h3><p class="scenic-address" data-v-8c811ca8${_scopeId}>\u{1F4CD} ${ssrInterpolate(item.address)}</p><div class="scenic-meta" data-v-8c811ca8${_scopeId}><span class="rating" data-v-8c811ca8${_scopeId}>\u2B50 ${ssrInterpolate(item.rating)}</span><span class="hours" data-v-8c811ca8${_scopeId}>\u{1F550} ${ssrInterpolate(item.openHours)}</span></div><p class="scenic-desc" data-v-8c811ca8${_scopeId}>${ssrInterpolate(item.description)}</p></div>`);
              } else {
                return [
                  createVNode("img", {
                    src: item.mainImage,
      ...
      if (activeTab.value === "route") {
        _push(`<div class="route-grid" data-v-8c811ca8><!--[-->`);
        ssrRenderList(routeList.value, (item, idx) => {
          _push(`<div class="route-card" data-v-8c811ca8>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<img${ssrRenderAttr("src", item.mainImage)}${ssrRenderAttr("alt", item.title)} class="route-img" data-v-8c811ca8${_scopeId}><div class="route-body" data-v-8c811ca8${_scopeId}><h3 class="route-title" data-v-8c811ca8${_scopeId}>${ssrInterpolate(item.title)}</h3><div class="route-days" data-v-8c811ca8${_scopeId}>\u{1F4C5} ${ssrInterpolate(item.days)}\u5929${ssrInterpolate(item.nights ? item.nights + "\u665A" : "")}</div><div class="route-includes" data-v-8c811ca8${_scopeId}><!--[-->`);
                ssrRenderList((item.includes || []).slice(0, 4), (inc, i) => {
                  _push2(`<span class="include-tag" data-v-8c811ca8${_scopeId}>${ssrInterpolate(inc)}</span>`);
                });
                _push2(`<!--]--></div><div class="route-price-row" data-v-8c811ca8${_scopeId}><span class="price" data-v-8c811ca8${_scopeId}>\xA5${ssrInterpolate(item.price)}</span><span class="price-unit" data-v-8c811ca8${_scopeId}>\u8D77/\u4EBA</span></div></div>`);
              } else {
                return [
                  createVNode("img", {
                    src: item.mainImage,
      ...
      if (activeTab.value === "guide") {
        _push(`<div class="guide-list" data-v-8c811ca8><!--[-->`);
        ssrRenderList(guideList.value, (item, idx) => {
          _push(`<div class="guide-card" data-v-8c811ca8>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="guide-body" data-v-8c811ca8${_scopeId}><h3 class="guide-title" data-v-8c811ca8${_scopeId}>${ssrInterpolate(item.title)}</h3><div class="guide-meta" data-v-8c811ca8${_scopeId}><span data-v-8c811ca8${_scopeId}>\u{1F680} ${ssrInterpolate(item.departure)} \u2192 ${ssrInterpolate(item.destination)}</span><span data-v-8c811ca8${_scopeId}>\u23F1 ${ssrInterpolate(item.duration)}</span><span data-v-8c811ca8${_scopeId}>\u{1F4B0} ${ssrInterpolate(item.cost)}</span></div><p class="guide-desc" data-v-8c811ca8${_scopeId}>${ssrInterpolate(item.description)}</p></div>`);
              } else {
                return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8c811ca8"]]);

export { index as default };
//# sourceMappingURL=index-CjLrcuws.mjs.map
