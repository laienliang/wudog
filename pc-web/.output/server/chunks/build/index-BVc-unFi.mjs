...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-page" }, _attrs))} data-v-8c1634ec><section class="hero-banner" data-v-8c1634ec>`);
            ...
            ssrRenderList(banners.value, (banner, idx) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), { key: idx }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="banner-item" style="${ssrRenderStyle({ backgroundImage: `url(${banner.image})` })}" data-v-8c1634ec${_scopeId2}><div class="banner-overlay" data-v-8c1634ec${_scopeId2}><h1 class="banner-title" data-v-8c1634ec${_scopeId2}>${ssrInterpolate(banner.title)}</h1><p class="banner-desc" data-v-8c1634ec${_scopeId2}>${ssrInterpolate(banner.description)}</p>`);
      ...
      _push(`</section><div class="miao-divider" data-v-8c1634ec></div><section class="module-entrances" data-v-8c1634ec><div class="container" data-v-8c1634ec><div class="module-grid" data-v-8c1634ec><!--[-->`);
      ssrRenderList(modules, (mod, idx) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="module-icon" style="${ssrRenderStyle({ backgroundColor: mod.color })}" data-v-8c1634ec${_scopeId}><span class="module-emoji" data-v-8c1634ec${_scopeId}>${ssrInterpolate(mod.emoji)}</span></div><h3 class="module-name" data-v-8c1634ec${_scopeId}>${ssrInterpolate(mod.name)}</h3><p class="module-desc" data-v-8c1634ec${_scopeId}>${ssrInterpolate(mod.description)}</p>`);
            } else {
              return [
                createVNode("div", {
                  class: "module-icon",
      ...
      _push(`<!--]--></div></div></section><section class="hot-section" data-v-8c1634ec><div class="container" data-v-8c1634ec><div class="section-header" data-v-8c1634ec><h2 class="section-title" data-v-8c1634ec>\u70ED\u95E8\u63A8\u8350</h2>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/clothing/list",
        class: "section-more"
      }, {
      ...
      _push(`</div><div class="hot-tabs" data-v-8c1634ec><!--[-->`);
      ssrRenderList(hotTabs, (tab) => {
        _push(`<button class="${ssrRenderClass(["hot-tab", { active: activeTab.value === tab.key }])}" data-v-8c1634ec>${ssrInterpolate(tab.label)}</button>`);
      });
      _push(`<!--]--></div><div class="hot-grid" data-v-8c1634ec><!--[-->`);
      ssrRenderList(displayedItems.value, (item, idx) => {
        _push(`<div class="goods-card" data-v-8c1634ec>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: item.link,
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", item.image)}${ssrRenderAttr("alt", item.title)} class="goods-card-img" data-v-8c1634ec${_scopeId}><div class="goods-card-body" data-v-8c1634ec${_scopeId}><h3 class="goods-card-title" data-v-8c1634ec${_scopeId}>${ssrInterpolate(item.title)}</h3><p class="goods-card-subtitle" data-v-8c1634ec${_scopeId}>${ssrInterpolate(item.subtitle)}</p><div class="goods-card-footer" data-v-8c1634ec${_scopeId}><span class="price" data-v-8c1634ec${_scopeId}>${ssrInterpolate(item.price)}</span><span class="goods-card-meta" data-v-8c1634ec${_scopeId}><span class="rating" data-v-8c1634ec${_scopeId}><!--[-->`);
              ssrRenderList(5, (s) => {
                _push2(`<span class="${ssrRenderClass(["star", { filled: s <= item.rating }])}" data-v-8c1634ec${_scopeId}>\u2605</span>`);
              });
              _push2(`<!--]--></span><span data-v-8c1634ec${_scopeId}>${ssrInterpolate(item.sales || item.likes || 0)}</span></span></div></div>`);
            } else {
              return [
                createVNode("img", {
                  src: item.image,
      ...
      _push(`<!--]--></div></div></section><section class="article-section" data-v-8c1634ec><div class="container" data-v-8c1634ec><div class="section-header" data-v-8c1634ec><h2 class="section-title" data-v-8c1634ec>\u7CBE\u9009\u6E38\u8BB0</h2>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/community/feed",
        class: "section-more"
      }, {
      ...
      _push(`</div><div class="article-grid" data-v-8c1634ec><!--[-->`);
      ssrRenderList(articles.value, (art, idx) => {
        _push(`<div class="article-card" data-v-8c1634ec>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", art.cover)} alt="" class="article-card-img" data-v-8c1634ec${_scopeId}><div class="article-card-body" data-v-8c1634ec${_scopeId}><h3 class="article-card-title" data-v-8c1634ec${_scopeId}>${ssrInterpolate(art.title)}</h3><div class="article-card-meta" data-v-8c1634ec${_scopeId}><img${ssrRenderAttr("src", art.authorAvatar)} alt="" class="author-avatar" data-v-8c1634ec${_scopeId}><span class="author-name" data-v-8c1634ec${_scopeId}>${ssrInterpolate(art.author)}</span><span class="article-stats" data-v-8c1634ec${_scopeId}>${ssrInterpolate(art.likes)}\u8D5E \xB7 ${ssrInterpolate(art.comments)}\u8BC4</span></div></div>`);
            } else {
              return [
                createVNode("img", {
                  src: art.cover,
      ...
      _push(`<!--]--></div></div></section><section class="about-section" data-v-8c1634ec><div class="container about-inner" data-v-8c1634ec><div class="about-text" data-v-8c1634ec><h2 data-v-8c1634ec>\u5173\u4E8E\u4E4C\u4E1C\u6587\u65C5</h2><p data-v-8c1634ec>\u4E4C\u4E1C\u6751\u662F\u8D35\u5DDE\u9ED4\u4E1C\u5357\u82D7\u65CF\u4F97\u65CF\u81EA\u6CBB\u5DDE\u6700\u5177\u7279\u8272\u7684\u82D7\u5BE8\u4E4B\u4E00\uFF0C\u62E5\u6709\u5343\u5E74\u5386\u53F2\u7684\u540A\u811A\u697C\u5EFA\u7B51\u7FA4\u3001\u7CBE\u7F8E\u7684\u94F6\u9970\u953B\u9020\u6280\u827A\u3001\u72EC\u7279\u7684\u8721\u67D3\u523A\u7EE3\u5DE5\u827A\u3002</p><p data-v-8c1634ec>\u672C\u5E73\u53F0\u81F4\u529B\u4E8E\u4E3A\u6E38\u5BA2\u63D0\u4F9B\u4E00\u7AD9\u5F0F&quot;\u8863\u3001\u98DF\u3001\u4F4F\u3001\u884C\u3001\u793E\u533A&quot;\u7EBF\u4E0A\u670D\u52A1\uFF0C\u8BA9\u60A8\u8DB3\u4E0D\u51FA\u6237\u5373\u53EF\u611F\u53D7\u82D7\u5BE8\u98CE\u60C5\u3002</p></div><div class="about-stats" data-v-8c1634ec><div class="stat-item" data-v-8c1634ec><span class="stat-num" data-v-8c1634ec>50+</span><span class="stat-label" data-v-8c1634ec>\u5165\u9A7B\u5546\u5BB6</span></div><div class="stat-item" data-v-8c1634ec><span class="stat-num" data-v-8c1634ec>200+</span><span class="stat-label" data-v-8c1634ec>\u975E\u9057\u5546\u54C1</span></div><div class="stat-item" data-v-8c1634ec><span class="stat-num" data-v-8c1634ec>1000+</span><span class="stat-label" data-v-8c1634ec>\u6708\u6D3B\u7528\u6237</span></div><div class="stat-item" data-v-8c1634ec><span class="stat-num" data-v-8c1634ec>500+</span><span class="stat-label" data-v-8c1634ec>\u6E38\u8BB0\u5206\u4EAB</span></div></div></div></section></div>`);
    };
  }
});
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8c1634ec"]]);

export { index as default };
//# sourceMappingURL=index-BVc-unFi.mjs.map
