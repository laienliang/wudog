...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "food-restaurant-page" }, _attrs))} data-v-fb81cbb7><div class="container page-inner" data-v-fb81cbb7><div class="page-header" data-v-fb81cbb7><h1 data-v-fb81cbb7>\u7F8E\u98DF\u9910\u5385</h1><p class="page-desc" data-v-fb81cbb7>\u82D7\u5BB6\u957F\u684C\u5BB4\u3001\u519C\u5BB6\u7279\u8272\u83DC\u3001\u519C\u4EA7\u54C1\u7279\u4EA7</p></div><div class="miao-divider" data-v-fb81cbb7></div><div class="restaurant-grid" data-v-fb81cbb7><!--[-->`);
      ssrRenderList(unref(restaurants), (item, idx) => {
        _push(`<div class="restaurant-card" data-v-fb81cbb7>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", item.cover)}${ssrRenderAttr("alt", item.name)} class="restaurant-cover" data-v-fb81cbb7${_scopeId}><div class="restaurant-body" data-v-fb81cbb7${_scopeId}><h3 class="restaurant-name" data-v-fb81cbb7${_scopeId}>${ssrInterpolate(item.name)}</h3><div class="restaurant-tags" data-v-fb81cbb7${_scopeId}><!--[-->`);
              ssrRenderList(item.tags, (t, i) => {
                _push2(`<span class="tag" data-v-fb81cbb7${_scopeId}>${ssrInterpolate(t)}</span>`);
              });
              _push2(`<!--]--></div><div class="restaurant-meta" data-v-fb81cbb7${_scopeId}><span class="rating" data-v-fb81cbb7${_scopeId}>\u2B50 ${ssrInterpolate(item.rating)}</span><span class="distance" data-v-fb81cbb7${_scopeId}>\u{1F4CD} ${ssrInterpolate(item.distance)}</span></div><p class="restaurant-desc" data-v-fb81cbb7${_scopeId}>${ssrInterpolate(item.description)}</p></div>`);
            } else {
              return [
                createVNode("img", {
                  src: item.cover,
...
const restaurant = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fb81cbb7"]]);

export { restaurant as default };
//# sourceMappingURL=restaurant-CpRiVD1G.mjs.map
