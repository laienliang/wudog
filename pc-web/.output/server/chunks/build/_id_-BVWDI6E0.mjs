...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "guide-page" }, _attrs))} data-v-3e8dbf43><div class="container" data-v-3e8dbf43>`);
      ...
      _push(`<article class="guide-article" data-v-3e8dbf43><span class="eyebrow" data-v-3e8dbf43>\u4EA4\u901A\u653B\u7565</span><h1 data-v-3e8dbf43>${ssrInterpolate(unref(guide).title)}</h1><div class="guide-meta" data-v-3e8dbf43><span data-v-3e8dbf43>\u{1F680} ${ssrInterpolate(unref(guide).departure)} \u2192 ${ssrInterpolate(unref(guide).destination)}</span><span data-v-3e8dbf43>\u23F1 ${ssrInterpolate(unref(guide).duration)}</span><span data-v-3e8dbf43>\u{1F4B0} ${ssrInterpolate(unref(guide).cost)}</span></div><p class="lead" data-v-3e8dbf43>${ssrInterpolate(unref(guide).description)}</p><div class="step-list" data-v-3e8dbf43><!--[-->`);
      ssrRenderList(unref(guide).steps, (step) => {
        _push(`<div class="step-item" data-v-3e8dbf43><strong data-v-3e8dbf43>${ssrInterpolate(step.title)}</strong><p data-v-3e8dbf43>${ssrInterpolate(step.content)}</p></div>`);
      });
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3e8dbf43"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-BVWDI6E0.mjs.map
