...
const REGIONS = {
  ...
  '重庆市': {
    '重庆市': ['渝中区', '江北区', '南岸区', '九龙坡区', '沙坪坝区', '大渡口区', '北碚区', '渝北区', '巴南区', '万州区', '涪陵区', '永川区', '江津区', '合川区', '黔江区', '长寿区', '南川区', '綦江区', '大足区', '璧山区', '铜梁区', '潼南区', '荣昌区', '开州区', '梁平区', '武隆区', '城口县', '丰都县', '垫江县', '忠县', '云阳县', '奉节县', '巫山县', '巫溪县', '石柱县', '秀山县', '酉阳县', '彭水县'],
  },
  '河北省': {
  ...
  '江苏省': {
    ...
    '苏州市': ['虎丘区', '吴中区', '相城区', '姑苏区', '吴江区', '昆山市', '太仓市'],
    '南通市': ['崇川区', '通州区', '海门区'],
    '连云港市': ['连云区', '海州区', '赣榆区'],
  ...
  '广东省': {
    ...
    '阳江市': ['江城区', '阳东区'],
    '清远市': ['清城区', '清新区'],
    '东莞市': ['莞城街道', '南城街道', '东城街道', '万江街道', '茶山镇', '石碣镇', '石龙镇', '茶山镇', '企石镇', '桥头镇', '横沥镇', '石排镇', '企石镇', '东坑镇', '常平镇', '寮步镇', '大朗镇', '黄江镇', '樟木头镇', '大岭山镇', '长安镇', '虎门镇', '厚街镇', '沙田镇', '道滘镇', '洪梅镇', '麻涌镇', '中堂镇', '高埗镇', '松山湖'],
    '中山市': ['石岐街道', '东区街道', '西区街道', '南区街道', '五桂山街道', '小榄镇', '古镇镇', '横栏镇', '东升镇', '港口镇', '大涌镇', '沙溪镇', '三乡镇', '火炬开发区'],
    '潮州市': ['湘桥区', '潮安区'],
    '揭阳市': ['榕城区', '揭东区'],
    '云浮市': ['云城区', '云安区'],
  },
  ...
  '四川省': {
    ...
    '凉山彝族自治州': ['西昌市', '会理市', '会东县', '宁南县', '普格县', '布拖县', '金阳县', '昭觉县', '喜德县', '冕宁县', '越西县', '甘洛县', '美姑县', '雷波县'],
  },
  '贵州省': {
  ...
  '云南省': {
    ...
    '大理白族自治州': ['大理市', '祥云县', '宾川县', '弥渡县', '永平县', '云龙县', '洱源县', '剑川县', '鹤庆县'],
    '德宏傣族景颇族自治州': ['芒市', '瑞丽市'],
    '怒江傈僳族自治州': ['泸水市'],
    '迪庆藏族自治州': ['香格里拉市'],
  },
