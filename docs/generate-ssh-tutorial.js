...
const doc = new Document({
  ...
  sections: [{
      ...
      header: {
        default: new Header({
          children: [
            new Paragraph({
              children: [
                new TextRun({ text: "SSH Key 配置完整教程", bold: true, font: "Arial", size: 20, color: "999999" }),
                new TextRun("\t"),
                new TextRun({ text: "wudog 项目文档", font: "Arial", size: 20, color: "999999" }),
              ],
      ...
      footer: {
        default: new Footer({
          children: [
            new Paragraph({
              children: [
                new TextRun({ text: "第 ", font: "Arial", size: 20 }),
    ...
    children: [
      // Title page
      new Paragraph({
        children: [new TextRun({ text: "SSH Key 配置完整教程", bold: true, font: "Arial", size: 54, color: "1F4E79" })],
        alignment: AlignmentType.CENTER,
        spacing: { before: 2400, after: 200 }
      }),
      new Paragraph({
        children: [new TextRun({ text: "—— Git 版本控制密钥管理指南", font: "Arial", size: 32, color: "2E75B6" })],
        alignment: AlignmentType.CENTER,
        spacing: { after: 200 }
      }),
      new Paragraph({
        children: [
          ...
          new TextRun({ text: "macOS / Linux / Windows (Git Bash, Git for Windows, VS Code)", font: "Arial", size: 26, color: "555555" })
        ],
        alignment: AlignmentType.CENTER,
        spacing: { after: 120 }
      }),
      new Paragraph({
        children: [
          ...
          new TextRun({ text: "GitHub / GitLab / Gitee / Bitbucket 等任意 SSH 认证服务", font: "Arial", size: 26, color: "555555" })
        ],
        alignment: AlignmentType.CENTER,
        spacing: { after: 120 }
      }),
      ...
      new Paragraph({
        ...
        border: {
          bottom: { style: BorderStyle.SINGLE, size: 6, color: "1F4E79", space: 1 }
        },
      ...
      // ===== SECTION 1 =====
      new Paragraph({
        children: [new TextRun({ text: "1. 什么是 SSH Key？", bold: true, font: "Arial", size: 32, color: "1F4E79" })],
        heading: HeadingLevel.HEADING_1,
        spacing: { before: 480, after: 200 }
      }),
      new Paragraph({
        children: [
          new TextRun({ text: "SSH Key（Secure Shell Key）是一种基于密钥的身份验证机制。与传统的用户名密码登录方式不同，", font: "Arial", size: 24, color: "333333" }),
          new TextRun({ text: "SSH Key 使用一对加密密钥来确认您的身份：", font: "Arial", size: 24, color: "333333" })
        ],
        spacing: { after: 120 }
      }),
      new Table({
        ...
        rows: [
          new TableRow({
            children: [
              new TableCell({
                borders: cellBorder, width: { size: 1805, type: WidthType.DXA },
              ...
              new TableCell({
                borders: cellBorder, width: { size: 7221, type: WidthType.DXA },
          ...
          new TableRow({
            children: [
              ...
              new TableCell({ borders: cellBorder, width: { size: 7221, type: WidthType.DXA }, margins: { top: 60, bottom: 60, left: 100, right: 100 },
                children: [new Paragraph({ children: [new TextRun({ text: "提交到 Git 平台（GitHub/Gitee 等），用于服务器端验证", font: "Arial", size: 24 })] })]
              })
            ]
          }),
          new TableRow({
      ...
      // ===== SECTION 2 =====
      new Paragraph({
        children: [new TextRun({ text: "2. 检查是否已有 SSH Key", bold: true, font: "Arial", size: 32, color: "1F4E79" })],
        heading: HeadingLevel.HEADING_1,
        spacing: { before: 480, after: 200 }
      }),
      new Paragraph({
      ...
      // ===== SECTION 3 =====
      new Paragraph({
        children: [new TextRun({ text: "3. 生成 SSH Key", bold: true, font: "Arial", size: 32, color: "1F4E79" })],
        heading: HeadingLevel.HEADING_1,
        spacing: { before: 480, after: 200 }
      }),
      new Paragraph({
      ...
      new Paragraph({
        children: [
          new TextRun({ text: "即使私钥文件被盗，没有密码短语也无法使用。如果不想每次输入，可以配合 ssh-agent 使用。", font: "Arial", size: 22, color: "555555" })
        ],
        spacing: { after: 120 }
      }),
      new Paragraph({
      ...
      new Paragraph({
        children: [new TextRun({ text: "3.3 备选方案：使用 RSA 算法", bold: true, font: "Arial", size: 28, color: "2E75B6" })],
        heading: HeadingLevel.HEADING_2,
        spacing: { before: 200, after: 120 }
      }),
      new Paragraph({
        children: [new TextRun({ text: "某些旧平台可能不支持 Ed25519，此时可以使用 RSA 算法：", font: "Arial", size: 24, color: "333333" })],
        spacing: { after: 80 }
      }),
      codeBlock('ssh-keygen -t rsa -b 4096 -C "your_email@example.com"'),
      new Paragraph({
        children: [
          new TextRun({ text: "参数 ", font: "Arial", size: 24, color: "333333" }),
          new TextRun({ text: "-b 4096", font: "Consolas", size: 22, color: "333333" }),
          new TextRun({ text: " 表示密钥长度为 4096 位，提供更高的安全性。", font: "Arial", size: 24, color: "333333" })
        ],
        spacing: { after: 200 }
      }),
      ...
      // ===== SECTION 4 =====
      new Paragraph({
        children: [new TextRun({ text: "4. 配置 ssh-agent", bold: true, font: "Arial", size: 32, color: "1F4E79" })],
        heading: HeadingLevel.HEADING_1,
        spacing: { before: 480, after: 200 }
      }),
      new Paragraph({
        children: [
          new TextRun({ text: "ssh-agent 是一个管理密钥的守护进程。配置后，你只需输入一次密码短语，后续操作无需重复输入。", font: "Arial", size: 24, color: "333333" })
        ],
        spacing: { after: 120 }
      }),

      new Paragraph({
        children: [new TextRun({ text: "4.1 macOS 系统", bold: true, font: "Arial", size: 28, color: "2E75B6" })],
        heading: HeadingLevel.HEADING_2,
        spacing: { before: 200, after: 80 }
      }),
      new Paragraph({
        children: [
          new TextRun({ text: "macOS 自带了 ssh-agent 的自动配置，只需在 ", font: "Arial", size: 24, color: "333333" }),
          new TextRun({ text: "~/.ssh/config", font: "Consolas", size: 22, color: "333333" }),
          new TextRun({ text: " 中添加配置即可：", font: "Arial", size: 24, color: "333333" })
        ],
        spacing: { after: 80 }
      }),
      new Paragraph({
        children: [new TextRun({ text: "第一步：创建或编辑 ~/.ssh/config 文件", bold: true, font: "Arial", size: 24, color: "1F4E79" })],
        spacing: { before: 80, after: 40 }
      }),
      codeBlock("touch ~/.ssh/config\nnano ~/.ssh/config"),
      new Paragraph({
        children: [new TextRun({ text: "第二步：添加以下内容并保存：", bold: true, font: "Arial", size: 24, color: "1F4E79" })],
        spacing: { before: 80, after: 40 }
      }),
      new Paragraph({
        style: "Code",
        children: [new TextRun({ text: "# ~/.ssh/config\nHost *\n    AddKeysToAgent yes\n    UseKeychain yes\n    IdentityFile ~/.ssh/id_ed25519", font: "Consolas", size: 22 })],
        shading: { type: ShadingType.CLEAR, fill: "F5F5F5" },
        border: {
          left: { style: BorderStyle.SINGLE, size: 6, color: "2E75B6", space: 1 },
          right: { style: BorderStyle.SINGLE, size: 6, color: "2E75B6", space: 1 },
      ...
      new Paragraph({
        children: [new TextRun({ text: "第三步：添加密钥到 ssh-agent", bold: true, font: "Arial", size: 24, color: "1F4E79" })],
        spacing: { before: 80, after: 40 }
      }),
      codeBlock("ssh-add --apple-use-keychain ~/.ssh/id_ed25519"),
      new Paragraph({
        children: [new TextRun({ text: "系统会弹出钥匙串访问对话框，输入密码后即可将密钥保存到系统钥匙串中。", font: "Arial", size: 24, color: "333333" })],
        spacing: { after: 200 }
      }),

      new Paragraph({
        children: [new TextRun({ text: "4.2 Linux 系统", bold: true, font: "Arial", size: 28, color: "2E75B6" })],
        heading: HeadingLevel.HEADING_2,
        spacing: { before: 200, after: 80 }
      }),
      new Paragraph({
        children: [new TextRun({ text: "Linux 系统需要手动启动 ssh-agent 并添加密钥：", font: "Arial", size: 24, color: "333333" })],
        spacing: { after: 80 }
      }),
      new Paragraph({
        children: [new TextRun({ text: "编辑 ~/.bashrc 或 ~/.zshrc，添加以下内容：", bold: true, font: "Arial", size: 24, color: "1F4E79" })],
        spacing: { before: 80, after: 40 }
      }),
      codeBlock("# 启动 ssh-agent 并加载密钥\neval \"$(ssh-agent -s)\"\nssh-add ~/.ssh/id_ed25519"),
      new Paragraph({
        children: [new TextRun({ text: "使配置生效：", bold: true, font: "Arial", size: 24, color: "1F4E79" })],
        spacing: { before: 80, after: 40 }
      }),
      ...
      new Paragraph({
        children: [new TextRun({ text: "4.3 Windows 系统", bold: true, font: "Arial", size: 28, color: "2E75B6" })],
        heading: HeadingLevel.HEADING_2,
        spacing: { before: 200, after: 80 }
      }),
      new Paragraph({
        children: [new TextRun({ text: "Windows 10/11 自带的 OpenSSH 支持自动启动 ssh-agent：", font: "Arial", size: 24, color: "333333" })],
        spacing: { after: 80 }
      }),
      new Paragraph({
        children: [new TextRun({ text: "第一步：设置 ssh-agent 开机自启：", bold: true, font: "Arial", size: 24, color: "1F4E79" })],
        spacing: { before: 80, after: 40 }
      }),
      codeBlock("Set-Service -Name ssh-agent -StartupType Automatic\nStart-Service ssh-agent"),
      new Paragraph({
        children: [new TextRun({ text: "第二步：添加密钥：", bold: true, font: "Arial", size: 24, color: "1F4E79" })],
        spacing: { before: 80, after: 40 }
      }),
      codeBlock("ssh-add ~/.ssh/id_ed25519"),
      new Paragraph({ spacing: { after: 200 } }),

      // ===== SECTION 5 =====
      new Paragraph({
        children: [new TextRun({ text: "5. 将公钥添加到 Git 平台", bold: true, font: "Arial", size: 32, color: "1F4E79" })],
        heading: HeadingLevel.HEADING_1,
        spacing: { before: 480, after: 200 }
      }),
      new Paragraph({
      ...
      // GitHub
      new Paragraph({
        children: [new TextRun({ text: "5.1 GitHub", bold: true, font: "Arial", size: 28, color: "2E75B6" })],
        heading: HeadingLevel.HEADING_2,
        spacing: { before: 120, after: 80 }
      }),
      new Paragraph({
      ...
      // Gitee
      new Paragraph({
        children: [new TextRun({ text: "5.2 Gitee（码云）", bold: true, font: "Arial", size: 28, color: "2E75B6" })],
        heading: HeadingLevel.HEADING_2,
        spacing: { before: 200, after: 80 }
      }),
      new Paragraph({
      ...
      // GitLab
      new Paragraph({
        children: [new TextRun({ text: "5.3 GitLab", bold: true, font: "Arial", size: 28, color: "2E75B6" })],
        heading: HeadingLevel.HEADING_2,
        spacing: { before: 200, after: 80 }
      }),
      new Paragraph({
      ...
      // ===== SECTION 6 =====
      new Paragraph({
        children: [new TextRun({ text: "6. 测试连接", bold: true, font: "Arial", size: 32, color: "1F4E79" })],
        heading: HeadingLevel.HEADING_1,
        spacing: { before: 480, after: 200 }
      }),
      new Paragraph({
      ...
      new Paragraph({
        children: [
          new TextRun({ text: "注意：这条信息是正常的！它表示认证成功，只是 GitHub 不提供 shell 访问权限。", font: "Arial", size: 22, color: "555555" })
        ],
        spacing: { after: 200 }
      }),
      new Paragraph({
      ...
      // ===== SECTION 7 =====
      new Paragraph({
        children: [new TextRun({ text: "7. 配置 Git 用户信息", bold: true, font: "Arial", size: 32, color: "1F4E79" })],
        heading: HeadingLevel.HEADING_1,
        spacing: { before: 480, after: 200 }
      }),
      new Paragraph({
        children: [
          new TextRun({ text: "使用 SSH Key 前，确保 Git 的用户名和邮箱与 Git 平台注册的一致：", font: "Arial", size: 24, color: "333333" })
        ],
        spacing: { after: 120 }
      }),
      new Paragraph({
      ...
      // ===== SECTION 8 =====
      new Paragraph({
        children: [new TextRun({ text: "8. 使用 SSH 克隆仓库", bold: true, font: "Arial", size: 32, color: "1F4E79" })],
        heading: HeadingLevel.HEADING_1,
        spacing: { before: 480, after: 200 }
      }),
      new Paragraph({
      ...
      // ===== SECTION 9 =====
      new Paragraph({
        children: [new TextRun({ text: "9. VS Code 中的 SSH Key 配置", bold: true, font: "Arial", size: 32, color: "1F4E79" })],
        heading: HeadingLevel.HEADING_1,
        spacing: { before: 480, after: 200 }
      }),
      new Paragraph({
        children: [
          new TextRun({ text: "VS Code 内置了 Git 支持，只要系统级 SSH Key 配置正确，VS Code 会自动使用。", font: "Arial", size: 24, color: "333333" })
        ],
        spacing: { after: 120 }
      }),
      new Paragraph({
        children: [new TextRun({ text: "配置步骤：", bold: true, font: "Arial", size: 24, color: "1F4E79" })],
        spacing: { before: 80, after: 40 }
      }),
      new Paragraph({
        children: [new TextRun({ text: "① 确保系统级 SSH Key 已配置完成（上述所有步骤）", font: "Arial", size: 24, color: "333333" })],
        spacing: { after: 40 }
      }),
      new Paragraph({
        children: [new TextRun({ text: "② 在 VS Code 中使用 SSH 地址克隆仓库", font: "Arial", size: 24, color: "333333" })],
        spacing: { after: 40 }
      }),
      new Paragraph({
        children: [
          new TextRun({ text: "③ 如需手动指定 SSH 密钥路径，在 ", font: "Arial", size: 24, color: "333333" }),
          new TextRun({ text: ".vscode/settings.json", font: "Consolas", size: 22, color: "333333" }),
          new TextRun({ text: " 中添加：", font: "Arial", size: 24, color: "333333" })
        ],
        spacing: { after: 40 }
      }),
      new Paragraph({
      ...
      // ===== SECTION 10 =====
      new Paragraph({
        children: [new TextRun({ text: "10. 常见问题排查", bold: true, font: "Arial", size: 32, color: "1F4E79" })],
        heading: HeadingLevel.HEADING_1,
        spacing: { before: 480, after: 200 }
      }),

      new Paragraph({
        children: [new TextRun({ text: "10.1 Permission denied (publickey)", bold: true, font: "Arial", size: 28, color: "FF0000" })],
        heading: HeadingLevel.HEADING_2,
      ...
      new Paragraph({
        children: [new TextRun({ text: "10.2 Host key verification failed", bold: true, font: "Arial", size: 28, color: "FF0000" })],
        heading: HeadingLevel.HEADING_2,
        spacing: { before: 160, after: 80 }
      }),
      new Paragraph({
      ...
      new Paragraph({
        children: [new TextRun({ text: "10.3 使用了错误的密钥", bold: true, font: "Arial", size: 28, color: "FF0000" })],
        heading: HeadingLevel.HEADING_2,
        spacing: { before: 160, after: 80 }
      }),
      new Paragraph({
      ...
      // ===== SECTION 11 =====
      new Paragraph({
        children: [new TextRun({ text: "11. 安全注意事项", bold: true, font: "Arial", size: 32, color: "1F4E79" })],
        heading: HeadingLevel.HEADING_1,
        spacing: { before: 480, after: 200 }
      }),
      new Table({
      ...
      // ===== SECTION 12 =====
      new Paragraph({
        children: [new TextRun({ text: "12. 撤销和重新生成密钥", bold: true, font: "Arial", size: 32, color: "1F4E79" })],
        heading: HeadingLevel.HEADING_1,
        spacing: { before: 480, after: 200 }
      }),
      new Paragraph({
        children: [new TextRun({ text: "如果需要撤销旧的 SSH Key（如设备丢失、换电脑等），请按以下步骤操作：", font: "Arial", size: 24, color: "333333" })],
        spacing: { after: 120 }
      }),
      new Paragraph({
        children: [new TextRun({ text: "第一步：在 Git 平台删除旧公钥", bold: true, font: "Arial", size: 26, color: "1F4E79" })],
        spacing: { before: 80, after: 40 }
      }),
      new Paragraph({
        children: [new TextRun({ text: "进入平台的 SSH Key 管理页面，找到对应的公钥记录并删除。", font: "Arial", size: 24, color: "333333" })],
        spacing: { after: 80 }
      }),
      new Paragraph({
        children: [new TextRun({ text: "第二步：删除本地旧密钥", bold: true, font: "Arial", size: 26, color: "1F4E79" })],
        spacing: { before: 80, after: 40 }
      }),
      codeBlock("rm ~/.ssh/id_ed25519 ~/.ssh/id_ed25519.pub"),
      new Paragraph({
        children: [new TextRun({ text: "第三步：按照第 3 节重新生成新的密钥对", font: "Arial", size: 24, color: "333333" })],
        spacing: { before: 80, after: 80 }
      }),
      new Paragraph({
        children: [new TextRun({ text: "第四步：将新公钥添加到 Git 平台", bold: true, font: "Arial", size: 26, color: "1F4E79" })],
        spacing: { before: 80, after: 40 }
      }),
      new Paragraph({
        children: [new TextRun({ text: "重复第 5 节的步骤，将新生成的公钥添加到所有需要的平台。", font: "Arial", size: 24, color: "333333" })],
        spacing: { after: 200 }
      }),

      // ===== APPENDIX =====
      new Paragraph({
        children: [new TextRun({ text: "附录：常用命令速查表", bold: true, font: "Arial", size: 32, color: "1F4E79" })],
        heading: HeadingLevel.HEADING_1,
        spacing: { before: 480, after: 200 }
      }),
      new Table({
      ...
      new Paragraph({
        children: [
          new TextRun({ text: "—— 文档结束 ——", font: "Arial", size: 24, color: "999999", italic: true })
        ],
        alignment: AlignmentType.CENTER,
